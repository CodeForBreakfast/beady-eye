...
**A bead's id is now shortened against the bead it is drawn under.** Most ids get shorter. One gets longer: a bead drawn under one it blocks rather than under its parent now draws its whole id, instead of reading as that bead's child.
